...
The Women's Empowerment Index (WEI) is calculated annually for each country on a **0–100 scale**:

| Pillar | Weight | Direction | Key Indicators |
|---|---|---|---|
| Empowerment | 25% | + Positive | Political seats, leadership, legal rights, freedom of movement |
| Education & Literacy | 20% | + Positive | Female literacy rate, enrollment, dropout rate, STEM participation |
| Economic Inclusion | 20% | + Positive | Wage gap, labour participation, property ownership, financial access |
| Health & Survival | 15% | + Positive | Maternal mortality, life expectancy, reproductive healthcare access |
| Safety (Crime Penalty) | 20% | − Penalty | Reported rape, domestic violence, femicide, trafficking, acid attacks |
...
All sub-scores normalised 0–100. Global WEI = population-weighted average of all country scores.
...
| **National Crime Records Bureau (India)** | State-level crime data for India sub-tokens |
| **State Government Portals** | Verified program data (e.g. Bengal, Kerala) |
