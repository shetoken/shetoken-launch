    ...
    <div className="mb-6 rounded-2xl border-2 border-dashed border-amber-400/50 bg-amber-400/5 p-4 flex items-start gap-3">
      ...
      <div className="text-sm">
        ...
        <p className="text-muted-foreground mt-0.5">
          You're previewing the v3 methodology. It <strong>reweights the five live pillars</strong> — heavier Economic
          Inclusion and Safety (Crime Penalty), lighter Empowerment and Education — so the scores shift versus v2, using
          only existing pillar data. Four further candidate pillars (Bodily Autonomy, Dignity &amp; Welfare, Digital &amp;
          Social, expanded Safety &amp; Justice) are still gathering data and contribute nothing yet. See the full
          breakdown on <Link to="/lab" className="text-accent hover:underline">The Lab</Link>.
        </p>
      </div>
    </div>
  );
